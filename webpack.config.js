...
module.exports = function (env, config) {
    ...
    return {
        entry: {
            member_import_menu: './src/Resources/assets/backend/javascript/member_import_menu.js',
            be_member_import: './src/Resources/assets/backend/javascript/be_member_import.js'
        },
        output: {
